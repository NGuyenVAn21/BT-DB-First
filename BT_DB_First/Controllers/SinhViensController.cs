...
namespace BT_DB_First.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ten,Tuoi,DiaChi")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,Tuoi,DiaChi")] SinhVien sinhVien)
        {
            if (id != sinhVien.Id)
            {
                return NotFound();
